...
```console
python -m pip install "https://github.com/sgh6688/gitlab-tools/releases/download/v0.3.1/gitlab_tools-0.3.1-py3-none-any.whl"
```
...
```console
python -m pip install --no-index ./gitlab_tools-0.3.1-py3-none-any.whl
```
