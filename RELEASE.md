...
gitlab_tools/__init__.py: 0.3.2
```
...
```text
dist/gitlab_tools-0.3.2-py3-none-any.whl
```
...
/tmp/gitlab-tools-release-check/bin/python -m pip install --no-index dist/gitlab_tools-0.3.2-py3-none-any.whl
...
release-check\Scripts\python -m pip install --no-index dist\gitlab_tools-0.3.2-py3-none-any.whl
...
```powershell
$wheel = "dist\gitlab_tools-0.3.2-py3-none-any.whl"
...
```bash
git tag -a v0.3.2 -m "gitlab-tools v0.3.2"
...
gitlab-tools\
  0.3.2\
    gitlab_tools-0.3.2-py3-none-any.whl
    SHA256SUMS.txt
```
